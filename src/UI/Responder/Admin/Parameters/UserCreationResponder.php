...
class UserCreationResponder implements UserCreationResponderInterface
{
    private $twig;
    ...
    /**
     * UserCreationResponder constructor.
     * @param $twig
     * @param $urlGenerator
     */
    ...
    public function response($redirect = false, FormInterface $form = null): Response
    {
        $redirect ?
            ...
            $response = new Response($this->twig->render('Security/user-creation.html.twig', [
