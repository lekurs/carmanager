...
final class GarageCreationResponder implements GarageCreationResponderInterface
{
    private $twig;
    ...
    /**
     * GarageCreationResponder constructor.
     * @param $twig
     * @param $urlGenerator
     */
    ...
    public function response($redirect = false, FormInterface $form = null): Response
    {
        $redirect ?
            ...
            $response = new Response($this->twig->render('admin/parameters/garage-creation.html.twig', [
